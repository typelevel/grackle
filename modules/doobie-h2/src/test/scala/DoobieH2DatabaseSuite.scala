...
trait DoobieH2DatabaseSuite extends DoobieDatabaseSuite {
  ...
  // Where the generated scripts live - see the `Test / javaOptions` setting for grackle-doobie-h2
  // in build.sbt, which points this at target/testdata/h2/ regardless of the fork's working
  // directory.
